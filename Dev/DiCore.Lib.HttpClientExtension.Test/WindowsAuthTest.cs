...
using Xunit;
using FileContent = DiCore.Lib.HttpClientExtension.FileContent;
using MultipartCollection = DiCore.Lib.HttpClientExtension.MultipartCollection;
using StringData = DiCore.Lib.HttpClientExtension.StringData;
...
{
    public class WindowsAuthTest : IClassFixture<WindowsAuthTestFixture>
    {
        ...
        public WindowsAuthTest(WindowsAuthTestFixture windowsAuthTestFixture)
        {
            storage = windowsAuthTestFixture.ServiceProvider.GetRequiredService<IStorage>();
            var clientFactory = windowsAuthTestFixture.ServiceProvider.GetRequiredService<IHttpClientFactory>();
