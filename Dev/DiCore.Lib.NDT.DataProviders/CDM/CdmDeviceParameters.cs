...
{
    public class CdmDeviceParameters : IDeviceParameters
    {
        ...
        public List<CdmDirection> Directions { get; set; }

        public static CdmDeviceParameters LoadFromOmni(string omniPath)
        {
            var cdlDeviceParameters = new CdmDeviceParameters();
            ReadFromOmni(cdlDeviceParameters, omniPath);
            return cdlDeviceParameters;
        }

        private static bool ReadFromOmni(CdmDeviceParameters deviceParameters, string omniPath)
        {
            ...
            try
            {
                ...
                var node = root.SelectSingleNode("CD360_CONSTANT_PARAMETERS");
                ...
                node = root.SelectSingleNode("CD360_CONSTANT_PARAMETERS");
                ...
                node = root.SelectSingleNode("CD360_CONSTANT_PARAMETERS/THRESHOLDS");
                ...
                deviceParameters.Directions = CdmDirectionHelper.LoadFromOmni(omniPath);
